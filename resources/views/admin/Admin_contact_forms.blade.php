...
@section('head')
    ...
    <title>Admin_contact_forms</title>
    <link rel="stylesheet" href="{{ css_path('Admin_contact_forms.css', 'admin') }}" media="screen">
    ...
    <meta name="twitter:title" content="Admin_contact_forms">
    <meta name="twitter:description" content="">
    <meta property="og:title" content="Admin_contact_forms">
    <meta property="og:type" content="website">
@endsection

<body class="u-body u-xl-mode" data-lang="en">
    @section('main-section')
        <section class="u-align-center u-clearfix u-gradient u-section-2" id="sec-ba05">
        ...
        <section class="u-align-center u-clearfix u-gradient u-section-3" id="sec-a58b">
                ...
                <table class="u-table-entity u-table-entity-1">
                    ...
                    <thead class="u-align-center u-black u-table-header u-table-header-1">
                        <tr style="height: 35px;">
                            ...
                            <th class="u-border-1 u-border-black u-table-cell">Contact Content</th>
                    ...
                    <tbody class="u-align-center u-table-body u-white u-table-body-1">
                        ...
                        @foreach ($contact as $item)
                            <tr style="height: 59px;">
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-6">{{ $item->id }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-7">{{ $item->name }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-8">{{ $item->email }}</td>
                                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-9">{{ $item->message }}
                                </td>
                                <td class="u-border-1 u-border-grey-30 u-table-cell u-table-cell-12">
                                    <form action="{{ url('/sagar/contact/' . $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
